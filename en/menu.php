				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item" id="renewInsurance">
						<a href="insuranceDetails" class="sidebar-link">
							<i class="align-middle me-2 fas fa-fw fa-check-square"></i> <span class="align-middle">Renew Insurance</span>
						</a>
					</li>

					<li class="sidebar-item" id="insuranceHistory">
						<a href="insuranceHistory" class="sidebar-link">
							<i class="align-middle me-2 fas fa-fw fa-book"></i> <span class="align-middle">Insurance History</span>
						</a>						
					</li>

					<li class="sidebar-item" id="logout">
						<a href="<?php echo BASE_URL;?>" class="sidebar-link">
							<i class="align-middle me-2 fas fa-fw fa-sign-out-alt"></i> <span class="align-middle">Logout</span>
						</a>						
					</li>
				</ul>
			</div>
